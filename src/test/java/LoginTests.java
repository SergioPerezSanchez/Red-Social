...
public class LoginTests {
	...
	public void El_usuario_va_a_acceder_al_sistema() throws Throwable {
		dao = new DAOPersona();
	    p=new Persona("Carlos", "Delgado", "carlitos93", "carlitos@hotmail.com", "a1Zs7s2DS", "Calle Jane Doe", "0", "photo", false, false);
	    assert(true);
	}
	...
	public void El_usuario_quiere_acceder_al_sistema() throws Throwable {
		dao = new DAOPersona();
	    p=new Persona("Carlos", "Delgado", "carlitos93", "carlitos@mail.com", "a1Zs7s2DM", "Calle Jane Doe", "0", "photo", false, false);
	    assert(true);
	}
