...
<title>Red Social - Reset Password</title>
...
<body>
	...
	<div class="container">
		...
		<p style="font-size: 20px; color:white;">¿No recuerdas tu contraseña? ¡No hay problema! <a style="cursor: pointer;font-size: 30px; color: white">¡Recuperála!</a></p>
		<!--  Aqui añadir un form -->
